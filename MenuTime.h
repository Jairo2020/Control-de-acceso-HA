...
*/
  ...
  /*!
    ...
    */
  /*bool entryTime1(unsigned long time, bool boton, byte control[], LiquidCrystal_I2C *lcd);*/
  /*!
    @method
    @param time tiempo dados en milisegundos.
    @param boton entrada del pulsador para controlar el menú.
     ...
     */
  bool entryTime(unsigned long time, bool boton, byte control[], LiquidCrystal_I2C *lcd);
...
/* bool MenuTime::entryTime1(unsigned long time, bool boton, byte control[], LiquidCrystal_I2C *lcd)
{
  if (boton == 1 && control[0] == 0)
  {
...
bool MenuTime::entryTime(unsigned long time, bool boton, byte control[], LiquidCrystal_I2C *lcd)
{
  if (control[0] == 0)
  {
    if (boton == 1)
